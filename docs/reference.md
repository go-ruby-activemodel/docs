...
The public API lives at the module root (`github.com/go-ruby-activemodel/activemodel`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `activemodel`, while the surface follows
...
```go
import "github.com/go-ruby-activemodel/activemodel"
```
...
- **[pkg.go.dev/github.com/go-ruby-activemodel/activemodel](https://pkg.go.dev/github.com/go-ruby-activemodel/activemodel)**

The module's [README](https://github.com/go-ruby-activemodel/activemodel#readme) carries worked
