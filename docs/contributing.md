...
Contributions are welcome. `go-ruby-activemodel/activemodel` is built to a small set of
...
The library is in [`github.com/go-ruby-activemodel/activemodel`](https://github.com/go-ruby-activemodel/activemodel).
This documentation site is in [`github.com/go-ruby-activemodel/docs`](https://github.com/go-ruby-activemodel/docs).
